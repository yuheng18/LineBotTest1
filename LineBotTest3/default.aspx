<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="LineBotTest3._default" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="ConfirmTemplate" />
    </form>
</body>
</html>
